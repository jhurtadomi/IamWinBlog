...
![Confirming child domain context](/assets/img/TrustADChildParent/pas1.png)
...
![Domain trust enumeration output](/assets/img/TrustADChildParent/pas2.png)
...
![SID filtering verification](/assets/img/TrustADChildParent/pas3.png)
...
![Child domain SID](/assets/img/TrustADChildParent/pas4.png)
...
![Enterprise Admins SID](/assets/img/TrustADChildParent/pas5.png)
...
![Golden Ticket forged and injected](/assets/img/TrustADChildParent/pas6.png)

We validate that the ticket is active in our current session using `klist`:

![Active Kerberos tickets via klist](/assets/img/TrustADChildParent/pas7.png)
...
![SYSVOL access on parent domain](/assets/img/TrustADChildParent/pas8.png)
...
![DCSync against parent domain krbtgt](/assets/img/TrustADChildParent/pas9.png)
