...
![BloodHound API key creation step 1](/assets/img/BloodHoundMCP/api_key.png)

![BloodHound API key creation step 2](/assets/img/BloodHoundMCP/api_key2.png)

![BloodHound API key creation step 3](/assets/img/BloodHoundMCP/api_key3.png)
...
![.env file with BloodHound credentials](/assets/img/BloodHoundMCP/env.png)
...
![Claude Desktop developer settings](/assets/img/BloodHoundMCP/claude_desktop.png)
...
![claude_desktop_config.json configuration](/assets/img/BloodHoundMCP/configjson.png)
...
![BloodHound MCP connected in Claude Desktop](/assets/img/BloodHoundMCP/test.png)
...
![Uploading BloodHound data zip](/assets/img/BloodHoundMCP/upload_test.png)

Now, from Claude Desktop:

![Test query 1 — Domain Admins](/assets/img/BloodHoundMCP/test1.png)
![Test query 2 — Kerberoastable users](/assets/img/BloodHoundMCP/test2.png)
![Test query 3 — Attack paths](/assets/img/BloodHoundMCP/test3.png)
![Test query 4 — High-value targets](/assets/img/BloodHoundMCP/test4.png)
![Test query 5 — Custom natural language query](/assets/img/BloodHoundMCP/test5.png)
