...
categories: [Red Teaming, Certifications]
...
![CRTP course methodology](/assets/img/CRTP/metodologia.png)
...
![Study session notes](/assets/img/CRTP/estudio.png)
...
![Lab environment view](/assets/img/CRTP/lab.png)

![Lab notes](/assets/img/CRTP/apuntes_lab.png)
...
> 📄 Report template: [Altered-Security-Reporting](https://github.com/didntchooseaname/Altered-Security-Reporting)

![Report cover](/assets/img/CRTP/report.png)

![Report content](/assets/img/CRTP/report1.png)

After about five days, I received an email saying that I had passed the exam:

![Approval email](/assets/img/CRTP/email.png)
...
![CRTP Certificate](/assets/img/CRTP/crtp_cert.jpg)
